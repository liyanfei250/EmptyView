 ...
 * 数字超过两位,显示99+
 */
public class BadgeMsgUtils {
    public static void show(MsgView msgView, int num,int maxNum) {
        if (msgView == null) {
            return;
        }
        ...
        if (num <= 0) {//圆点,设置默认宽高
            ...
            if (num > 0 && num < 10) {//圆
                ...
                msgView.setText(num + "");
            } else if (num > 9 && num < maxNum) {//圆角矩形,圆角是高度的一半,设置默认padding
