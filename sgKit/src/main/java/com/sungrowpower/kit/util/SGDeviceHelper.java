...
public class SGDeviceHelper {
  private final static String TAG = "SGDeviceHelper";
  ...
  private static void checkReadInfo() {
    ...
    if (Build.VERSION.SDK_INT < Build.VERSION_CODES.O) {
      ...
      try {
        ...
        SGUILog.printErrStackTrace(TAG, e, "read file error");
      } finally {
        SGLangHelper.close(fileInputStream);
      }
    }
    ...
    try {
      ...
      SGUILog.printErrStackTrace(TAG, e, "read SystemProperties error");
    }
  }
