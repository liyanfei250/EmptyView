...
import com.sungrowpower.kit.util.SGResHelper;
import java.lang.ref.WeakReference;

/**
 */

public class SGLayoutHelper implements ISGUILayout {
  ...
  private int mRadius;
  private @ISGUILayout.HideRadiusSide int mHideRadiusSide = HIDE_RADIUS_SIDE_NONE;
  ...
  public SGLayoutHelper(Context context, AttributeSet attrs, int defAttr, View owner) {
    this(context, attrs, defAttr, 0, owner);
  }

  public SGLayoutHelper(Context context, AttributeSet attrs, int defAttr, int defStyleRes, View owner) {
    mContext = context;
    mOwner = new WeakReference<>(owner);
    mBottomDividerColor = mTopDividerColor =
        ContextCompat.getColor(context, R.color.sgkit_config_color_separator);
    mMode = new PorterDuffXfermode(PorterDuff.Mode.DST_OUT);
    mClipPaint = new Paint();
    mClipPaint.setAntiAlias(true);
    mShadowAlpha = SGResHelper.getAttrFloatValue(context, R.attr.sgkit_general_shadow_alpha);
    mBorderRect = new RectF();

    int radius = 0, shadow = 0;
    boolean useThemeGeneralShadowElevation = false;
    if (null != attrs || defAttr != 0 || defStyleRes != 0) {
      TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.SGKitLayout, defAttr, defStyleRes);
      mWidthLimit = ta.getDimensionPixelSize(R.styleable.SGKitLayout_android_maxWidth, mWidthLimit);
      mHeightLimit = ta.getDimensionPixelSize(R.styleable.SGKitLayout_android_minWidth, mHeightLimit);
      mWidthMini = ta.getDimensionPixelSize(R.styleable.SGKitLayout_android_minWidth, mWidthMini);
      mHeightMini = ta.getDimensionPixelSize(R.styleable.SGKitLayout_android_minHeight, mHeightMini);
      mTopDividerColor = ta.getColor(R.styleable.SGKitLayout_sgkit_topDividerColor, mTopDividerColor);
      mTopDividerHeight = ta.getDimensionPixelSize(R.styleable.SGKitLayout_sgkit_topDividerHeight, mTopDividerHeight);
      mTopDividerInsetLeft = ta.getDimensionPixelSize(R.styleable.SGKitLayout_sgkit_topDividerInsetLeft, mTopDividerInsetLeft);
      mTopDividerInsetRight = ta.getDimensionPixelSize(R.styleable.SGKitLayout_sgkit_topDividerInsetRight, mTopDividerInsetRight);
      mBottomDividerColor = ta.getColor(R.styleable.SGKitLayout_sgkit_bottomDividerColor, mBottomDividerColor);
      mBottomDividerHeight = ta.getDimensionPixelSize(R.styleable.SGKitLayout_sgkit_bottomDividerHeight, mBottomDividerHeight);
      mBottomDividerInsetLeft = ta.getDimensionPixelSize(R.styleable.SGKitLayout_sgkit_bottomDividerInsetLeft, mBottomDividerInsetLeft);
      mBottomDividerInsetRight = ta.getDimensionPixelSize(R.styleable.SGKitLayout_sgkit_bottomDividerInsetRight, mBottomDividerInsetRight);
      mLeftDividerColor = ta.getColor(R.styleable.SGKitLayout_sgkit_leftDividerColor, mLeftDividerColor);
      mLeftDividerWidth = ta.getDimensionPixelSize(R.styleable.SGKitLayout_sgkit_leftDividerWidth, mLeftDividerWidth);
      mLeftDividerInsetTop = ta.getDimensionPixelSize(R.styleable.SGKitLayout_sgkit_leftDividerInsetTop, mLeftDividerInsetTop);
      mLeftDividerInsetBottom = ta.getDimensionPixelSize(R.styleable.SGKitLayout_sgkit_leftDividerInsetBottom, mLeftDividerInsetBottom);
      mRightDividerColor = ta.getColor(R.styleable.SGKitLayout_sgkit_rightDividerColor, mRightDividerColor);
      mRightDividerWidth = ta.getDimensionPixelSize(R.styleable.SGKitLayout_sgkit_rightDividerWidth, mRightDividerWidth);
      mRightDividerInsetTop = ta.getDimensionPixelSize(R.styleable.SGKitLayout_sgkit_rightDividerInsetTop, mRightDividerInsetTop);
      mRightDividerInsetBottom = ta.getDimensionPixelSize(R.styleable.SGKitLayout_sgkit_rightDividerInsetBottom, mRightDividerInsetBottom);
      mBorderColor = ta.getColor(R.styleable.SGKitLayout_sgkit_borderColor, mBorderColor);
      mBorderWidth = ta.getDimensionPixelSize(R.styleable.SGKitLayout_sgkit_borderWidth, mBorderWidth);
      radius = ta.getDimensionPixelSize(R.styleable.SGKitLayout_sgkit_radius, 0);
      mOuterNormalColor = ta.getColor(R.styleable.SGKitLayout_sgkit_outerNormalColor, mOuterNormalColor);
      mHideRadiusSide = ta.getInt(R.styleable.SGKitLayout_sgkit_hideRadiusSide, mHideRadiusSide);
      mIsShowBorderOnlyBeforeL = ta.getBoolean(R.styleable.SGKitLayout_sgkit_showBorderOnlyBeforeL, mIsShowBorderOnlyBeforeL);
      shadow = ta.getDimensionPixelSize(R.styleable.SGKitLayout_sgkit_shadowElevation, shadow);
      mShadowAlpha = ta.getFloat(R.styleable.SGKitLayout_sgkit_shadowAlpha, mShadowAlpha);
      useThemeGeneralShadowElevation = ta.getBoolean(R.styleable.SGKitLayout_sgkit_useThemeGeneralShadowElevation, false);
      mOutlineInsetLeft = ta.getDimensionPixelSize(R.styleable.SGKitLayout_sgkit_outlineInsetLeft, 0);
      mOutlineInsetRight = ta.getDimensionPixelSize(R.styleable.SGKitLayout_sgkit_outlineInsetRight, 0);
      mOutlineInsetTop = ta.getDimensionPixelSize(R.styleable.SGKitLayout_sgkit_outlineInsetTop, 0);
      mOutlineInsetBottom = ta.getDimensionPixelSize(R.styleable.SGKitLayout_sgkit_outlineInsetBottom, 0);
      mIsOutlineExcludePadding = ta.getBoolean(R.styleable.SGKitLayout_sgkit_outlineExcludePadding, false);
      ta.recycle();
    }
    if (shadow == 0 && useThemeGeneralShadowElevation) {
      shadow = SGResHelper.getAttrDimen(context, R.attr.sgkit_general_shadow_elevation);
    }
  ...
  public void setUseThemeGeneralShadowElevation() {
    mShadowElevation = SGResHelper.getAttrDimen(mContext, R.attr.sgkit_general_shadow_elevation);
  ...
  @Override
  public void setRadius(int radius, @ISGUILayout.HideRadiusSide int hideRadiusSide) {
  ...
  @Override
  public void setRadiusAndShadow(int radius, @ISGUILayout.HideRadiusSide int hideRadiusSide, int shadowElevation, float shadowAlpha) {
