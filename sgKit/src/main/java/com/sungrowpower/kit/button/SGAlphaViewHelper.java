...
public class SGAlphaViewHelper {
  ...
  public SGAlphaViewHelper(@NonNull View target) {
    mTarget = new WeakReference<>(target);
    mPressedAlpha = SGResHelper.getAttrFloatValue(target.getContext(), R.attr.sgkit_alpha_pressed);
    mDisabledAlpha = SGResHelper.getAttrFloatValue(target.getContext(), R.attr.sgkit_alpha_disabled);
  }

  public SGAlphaViewHelper(@NonNull View target, float pressedAlpha, float disabledAlpha) {
    mTarget = new WeakReference<>(target);
